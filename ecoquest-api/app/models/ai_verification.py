...
class AIVerification(Base):
    ...
    duplicate_score: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    verified_by: Mapped[Optional[uuid.UUID]] = mapped_column(ForeignKey("users.user_id", ondelete="SET NULL"), nullable=True)
