...
class SecurityEvent(Base):
    ...
    verification_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("ai_verification.verification_id", ondelete="CASCADE"), nullable=True)
    ...
    resolved_by: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("users.user_id", ondelete="SET NULL"), nullable=True)
