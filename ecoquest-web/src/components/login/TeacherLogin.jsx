...
export default function TeacherLogin({ onLoginSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    await loginUser(teacherId || 'educator@ecoquest.org', password, 'educator');
      ...
      >
        {loading ? (
          <>
            ...
            <span>Connecting Teacher Portal...</span>
          </>
        ) : success ? (
          <span>Portal Access Granted! Redirecting... 🌿</span>
        ) : (
          <>
            <span>Login as Educator</span>
