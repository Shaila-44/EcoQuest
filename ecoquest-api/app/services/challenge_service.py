...
class ChallengeService:
    ...
    async def create_challenge(self, data: ChallengeCreate, creator: User) -> Challenge:
    ...
    async def get_daily_challenge(self, school_id: uuid.UUID) -> Challenge | None:
        ...
        if not challenge:
            ...
            active_challenges = await self.challenge_repo.get_active_by_school(school_id)
    ...
    async def delete_challenge(self, challenge_id: uuid.UUID, user: User) -> None:
        """Delete a challenge."""
        challenge = await self.get_challenge(challenge_id)
